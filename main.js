...
uleeces.address.push('1234');
uleeces.address.push('REEEEE Street');
uleeces.address.push('01982');
...
myNewCodeImmersivesObj = {
  objectify: 'myself',
  isAnAwesomeObject: true,
  term: 11,
  memes: ['pepe', 'teletubbies'];
}
